...
#[derive(Debug)]
pub struct PhotoMiniProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PhotoMiniProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PhotoMini processing");
    
    let mut processor = PhotoMiniProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PhotoMiniProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PhotoMiniProcessor::new(false);
